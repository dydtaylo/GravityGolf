...
public class Ball
{
	...
	public Ball(double xPos, double yPos, double s, double rot, int r, double sW, double sH)
	{
		x = xPos;
		y = yPos;
		speed = s;
	...
	public void draw(Graphics g, JPanel screen)
	{
		checkPosition();
		move();
		g.drawImage(image, (int) x - radius/2, (int) y - radius/2, screen);
	}
